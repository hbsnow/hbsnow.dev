...
IE11 のおかげで、これの完全なサポートが必要になるのであれば、使うことができない。また、検証環境は Mac Chrome の 81 で動作の確認をしてみたところ、ちょっと思った以上に思っていない挙動をとったので、まだ使うのはちょっと厳しいかもしれない。実際に使用するときにはちゃんといくつかのブラウザで挙動を確認しておくことをおすすめする。
